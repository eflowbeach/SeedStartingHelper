...
var envinfo = {"qx.application":"gardenplanner.Application","qx.revision":"","qx.theme":"gardenplanner.theme.Theme","qx.version":"5.0"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"gardenplanner":{"resourceUri":"../source/resource","sourceUri":"../source/class"},"qx":{"resourceUri":"../../edd/libs/qooxdoo-5.0-sdk/framework/source/resource","sourceUri":"../../edd/libs/qooxdoo-5.0-sdk/framework/source/class","sourceViewUri":"https://github.com/qooxdoo/qooxdoo/blob/%{qxGitBranch}/framework/source/class/%{classFilePath}#L%{lineNumber}"}};
